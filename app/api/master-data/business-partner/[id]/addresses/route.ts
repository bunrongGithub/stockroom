...
export async function GET(req: NextRequest, { params }: Params) {
    try {
        ...
        const data = await Service.listAddresses(ctx, parsed.data.id);
...
export async function POST(req: NextRequest, { params }: Params) {
    try {
        ...
        const bodyParsed = businessPartnerAddressSchema.safeParse(await req.json());
        ...
        const data = await Service.addAddress(ctx, parsed.data.id, bodyParsed.data);
