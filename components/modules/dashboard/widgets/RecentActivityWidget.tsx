...
const TABS = [
    { id: 'orders' as const, label: 'Orders', href: (id: number) => `/sale/order/${id}/view` },
    { id: 'shipments' as const, label: 'Shipments', href: (id: number) => `/sale/delivery-note/${id}/view` },
    { id: 'invoices' as const, label: 'Invoices', href: (id: number) => `/sale/invoice/${id}/view` },
];
