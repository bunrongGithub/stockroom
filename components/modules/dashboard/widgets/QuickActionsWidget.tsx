...
const ACTIONS: { label: string; href: string; icon: LucideIcon }[] = [
    { label: 'New Sales Order', href: '/sale/order/create', icon: ShoppingCartIcon },
    { label: 'New Shipment', href: '/sale/delivery-note/create', icon: TruckIcon },
    { label: 'New Sales Invoice', href: '/sale/invoice/create', icon: FileTextIcon },
    { label: 'New Inventory Receipt', href: '/inventory/receipt/create', icon: PackagePlusIcon },
    { label: 'New Stock Item', href: '/inventory/configurations/stock-item/create', icon: PlusIcon },
];
