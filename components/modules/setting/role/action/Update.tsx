...
const PERM_FIELDS = ['can_view', 'can_create', 'can_update', 'can_delete'] as const;
...
export default function Update({ currentPath, permission, currentPathActions }: ModuleProps) {
    ...
    const [newModule, setNewModule] = useState<{ id: number; label: string } | null>(null);
    ...
    const addModule = () => {
        ...
        setNewModule(null);
        setNewPerms({ can_view: true, can_create: false, can_update: false, can_delete: false });
    };
                            ...
                            {filteredPerms.length === 0 && (
                                <tr>
                                    <td colSpan={7} className="py-8 text-center text-sm text-slate-400">
                                        {search ? 'No modules match your filter.' : 'No permissions yet.'}
                                    </td>
                                </tr>
                            )}
