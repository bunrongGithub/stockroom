...
export default function Get({ currentPath, permission, currentPathActions }: ModuleProps) {
    ...
    if (error || !data) {
        return <p className="py-10 text-center text-sm text-red-500">{error || 'Role not found.'}</p>;
    }
