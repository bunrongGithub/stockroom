...
export default function BranchForm({ branch, onClose, onSuccess }: Props) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setSubmitting(true);
        try {
            const url = isEdit ? `/api/branch/${branch.id}` : '/api/branch';
            ...
            <div className="relative w-full max-w-md rounded-2xl bg-white shadow-2xl">
                ...
                <div className="border-b border-slate-100 px-6 py-5">
                    ...
                    <p className="mt-0.5 text-sm text-slate-500">
                        {isEdit
                            ? 'កែ​ប្រែ​ព័ត៌មាន​សាខា​អាជីវកម្ម'
                            : 'បន្ថែម​សាខា​​ថ្មី — Main Storage ​នឹង​ត្រូវ​បាន​បង្កើត​ស្វ័យ​ប្រវត្តិ'}
                    </p>
                </div>
                    ...
                    <div className="space-y-5 px-6 py-6">
                        <div>
                            ...
                            <EditableInput
                                ...
                                placeholder="e.g. iCase Phsar Thmey"
                                required
                            />
                        </div>
