...
function CategoryUpdateForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setTimeout(() => router.push('/inventory/configurations/category'), 1200);
    } catch (err) {
      showToast(
    ...
    <>
      ...
      <div className="max-w-xl space-y-6 animate-in fade-in duration-500">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">កែប្រែប្រភេទទំនិញ #{id}</p>
        </div>
        ...
        >
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <button
              type="button"
              onClick={() => router.push('/inventory/configurations/category')}
