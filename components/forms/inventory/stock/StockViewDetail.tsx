...
export default function StockViewDetail({ item }: { item: StockViewItem }) {
    ...
    const profitMargin =
        (item.price ?? 0) > 0
            ...
            : '0.0';
    const imageUrl = item.images_url?.[0] ?? '';
                    ...
                    <section className="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm">
                        ...
                        <div className="p-4">
                            {imageUrl ? (
                                ...
                                <div className="flex aspect-square w-full items-center justify-center rounded-xl border border-dashed border-slate-200 bg-slate-50">
                                    <div className="text-center">
                                        <Package size={32} className="mx-auto text-slate-200" />
                                        <p className="mt-1 text-xs text-slate-300">No image</p>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="space-y-5 pt-5">
                            <section className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
                                ...
                                <div className="grid gap-3 sm:grid-cols-2">
                                    <ReadonlyToggle
                                        checked={!!item.warranty_duration}
